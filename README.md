...
To use it: create a new repo named EXACTLY  the-priest  (same as your username),
public, "Add a README", then replace that README's contents with this file and commit.
GitHub will render it as the front page of github.com/the-priest — the single
strongest thing search engines index about you.
-->
